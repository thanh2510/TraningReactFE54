...
import style from "./BaiTapRenderDSPhim.module.css";
...
export default class BaiTapRenderDSPhim extends Component {
  ...
  renderDSPhim = () => {
    let arrRenderDSPhim = this.mangPhim.map((phim, index) => {
      ...
      <h4 className="card-title" style={{height:'50px'}}>{phim.tenPhim.length > 20 ? <span>{phim.tenPhim.substr(0,20)} ...</span> : <span> {phim.tenPhim}</span>}</h4>
